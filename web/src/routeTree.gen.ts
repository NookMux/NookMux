...
import { Route as KeyQueryIndexRouteImport } from './routes/key-query/index'
...
const KeyQueryIndexRoute = KeyQueryIndexRouteImport.update({
  id: '/key-query/',
  path: '/key-query/',
  getParentRoute: () => rootRouteImport,
} as any)
...
const AuthenticatedMultimodalCustomVoiceIndexRoute =
  AuthenticatedMultimodalCustomVoiceIndexRouteImport.update({
    id: '/multimodal/custom-voice/',
...
export interface FileRoutesByFullPath {
  ...
  '/key-query/': typeof KeyQueryIndexRoute
...
export interface RootRouteChildren {
  ...
  KeyQueryIndexRoute: typeof KeyQueryIndexRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/key-query/': {
      ...
      path: '/key-query'
      fullPath: '/key-query/'
      preLoaderRoute: typeof KeyQueryIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/oauth/$provider': {
      id: '/oauth/$provider'
    ...
    '/_authenticated/multimodal/custom-voice/': {
      id: '/_authenticated/multimodal/custom-voice/'
      path: '/multimodal/custom-voice'
      fullPath: '/multimodal/custom-voice/'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  KeyQueryIndexRoute: KeyQueryIndexRoute,
