...
const (
	...
	MsgChannelResetCardUnsupported             = "channel.reset_card_unsupported"
	MsgChannelResetCardQueryFailed             = "channel.reset_card_query_failed"
	MsgChannelResetCardUseFailed               = "channel.reset_card_use_failed"
	...
	MsgChannelNotifyTestCompletedTitle         = "channel.notify_test_completed_title"
	MsgChannelNotifyTestCompletedBody          = "channel.notify_test_completed_body"
	MsgChannelNotifyDisabledTitle              = "channel.notify_disabled_title"
	MsgChannelNotifyDisabledBody               = "channel.notify_disabled_body"
	MsgChannelNotifyEnabledTitle               = "channel.notify_enabled_title"
	MsgChannelNotifyEnabledBody                = "channel.notify_enabled_body"
	MsgChannelDisableReasonQuotaUsedUp         = "channel.disable_reason_quota_used_up"
)
...
const (
	MsgAuthNoPermissionNotLoggedIn = "auth.no_permission_not_logged_in"
	...
	MsgAuthMissingNewAPIUser       = "auth.missing_new_api_user"
	MsgAuthInvalidNewAPIUser       = "auth.invalid_new_api_user"
	MsgAuthNewAPIUserMismatch      = "auth.new_api_user_mismatch"
	MsgAuthUserBanned              = "auth.user_banned"
	MsgAuthInsufficientPermission  = "auth.insufficient_permission"
	MsgAuthInvalidClientIP         = "auth.invalid_client_ip"
...
// Distributor middleware messages
const (
	...
	MsgDistributorTokenModelNotAllowed   = "distributor.token_model_not_allowed"
	MsgDistributorModelRequired          = "distributor.model_required"
	MsgDistributorInvalidPlaygroundReq   = "distributor.invalid_playground_request"
	MsgDistributorGroupAccessDenied      = "distributor.group_access_denied"
	MsgDistributorSelectChannelFailed    = "distributor.select_channel_failed"
...
// Console settings validation messages (admin config)
const (
	MsgConsoleTypeApiInfo        = "console.type_api_info"
	MsgConsoleTypeAnnouncement   = "console.type_announcement"
	MsgConsoleTypeFaq            = "console.type_faq"
	MsgConsoleTypeUptimeKuma     = "console.type_uptime_kuma_group"
	MsgConsoleTypeGroup          = "console.type_group"
	MsgConsoleParseFailed        = "console.parse_failed"
	MsgConsoleURLFormatInvalid   = "console.url_format_invalid"
	MsgConsoleURLParseFailed     = "console.url_parse_failed"
	MsgConsoleDangerousContent   = "console.dangerous_content"
	MsgConsoleUnknownSettingType = "console.unknown_setting_type"

	MsgConsoleUsageLogFieldsParseFailed  = "console.usage_log_fields_parse_failed"
	MsgConsoleUsageLogFieldUnknown       = "console.usage_log_field_unknown"
	MsgConsoleUsageLogFieldParseFailed   = "console.usage_log_field_parse_failed"
	MsgConsoleUsageLogFieldMissingAdmin  = "console.usage_log_field_missing_admin"
	MsgConsoleUsageLogFieldMissingUser   = "console.usage_log_field_missing_user"
	MsgConsoleUsageLogFieldAdminNotBool  = "console.usage_log_field_admin_not_bool"
	MsgConsoleUsageLogFieldUserNotBool   = "console.usage_log_field_user_not_bool"
	MsgConsoleApiInfoLimitExceeded       = "console.api_info_limit_exceeded"
	...
	MsgConsoleAnnouncementLimitExceeded  = "console.announcement_limit_exceeded"
	MsgConsoleAnnouncementMissingContent = "console.announcement_missing_content"
	MsgConsoleAnnouncementMissingDate    = "console.announcement_missing_publish_date"
	MsgConsoleAnnouncementDateEmpty      = "console.announcement_publish_date_empty"
	MsgConsoleAnnouncementDateInvalid    = "console.announcement_publish_date_invalid"
	...
	MsgConsoleFaqLimitExceeded           = "console.faq_limit_exceeded"
	...
	MsgConsoleUptimeKumaLimitExceeded    = "console.uptime_kuma_limit_exceeded"
	MsgConsoleGroupMissingCategoryName   = "console.group_missing_category_name"
	MsgConsoleGroupCategoryNameDuplicate = "console.group_category_name_duplicate"
	MsgConsoleGroupMissingURL            = "console.group_missing_url"
	MsgConsoleGroupMissingSlug           = "console.group_missing_slug"
	MsgConsoleGroupCategoryNameTooLong   = "console.group_category_name_too_long"
	MsgConsoleGroupURLTooLong            = "console.group_url_too_long"
	MsgConsoleGroupSlugTooLong           = "console.group_slug_too_long"
	MsgConsoleGroupDescriptionTooLong    = "console.group_description_too_long"
	MsgConsoleGroupSlugInvalid           = "console.group_slug_invalid"
)

// Dashboard config validation messages (admin config)
const (
	MsgDashboardQuotaRefreshIntervalRange   = "dashboard.quota_refresh_interval_range"
	MsgDashboardAnalyticsRefreshIntervalRng = "dashboard.user_analytics_refresh_interval_range"
	MsgDashboardRankingsRefreshIntervalRng  = "dashboard.rankings_refresh_interval_range"
	MsgDashboardUptimeKumaRefreshInterval   = "dashboard.uptime_kuma_refresh_interval_range"
	MsgDashboardMaxTimeRangeRange           = "dashboard.max_time_range_range"
	MsgDashboardDefaultTimeRangeRange       = "dashboard.default_time_range_range"
	MsgDashboardRankingsModelLimitRange     = "dashboard.rankings_model_limit_range"
	MsgDashboardRankingsVendorLimitRange    = "dashboard.rankings_vendor_limit_range"
	MsgDashboardUserAnalyticsTopNRange      = "dashboard.user_analytics_top_n_range"
	MsgDashboardDefaultTimeRangeExceedsMax  = "dashboard.default_time_range_exceeds_max"
)

// Ollama channel operation messages
const (
	MsgOllamaProxyClientCreateFailed = "ollama.proxy_client_create_failed"
	MsgOllamaClientCreateFailed      = "ollama.client_create_failed"
	MsgOllamaRequestCreateFailed     = "ollama.request_create_failed"
	MsgOllamaRequestSerializeFailed  = "ollama.request_serialize_failed"
	MsgOllamaRequestFailed           = "ollama.request_failed"
	MsgOllamaUnexpectedStatus        = "ollama.unexpected_status"
	MsgOllamaResponseReadFailed      = "ollama.response_read_failed"
	MsgOllamaResponseParseFailed     = "ollama.response_parse_failed"
	MsgOllamaPullModelStatusFailed   = "ollama.pull_model_status_failed"
	MsgOllamaPullModelFailed         = "ollama.pull_model_failed"
	MsgOllamaPullStreamReadFailed    = "ollama.pull_stream_read_failed"
	MsgOllamaPullNotCompleted        = "ollama.pull_not_completed"
	MsgOllamaDeleteModelFailed       = "ollama.delete_model_failed"
	MsgOllamaBaseURLEmpty            = "ollama.base_url_empty"
	MsgOllamaVersionQueryFailed      = "ollama.version_query_failed"
	MsgOllamaVersionNotReturned      = "ollama.version_not_returned"
)

// Custom voice messages
const (
	MsgCustomVoiceVoiceIdInvalid            = "custom_voice.voice_id_invalid"
	MsgCustomVoiceAudioFileEmpty            = "custom_voice.audio_file_empty"
	MsgCustomVoiceAudioFileTooLarge         = "custom_voice.audio_file_too_large"
	MsgCustomVoiceAudioFormatUnsupported    = "custom_voice.audio_format_unsupported"
	MsgCustomVoiceChannelNotFound           = "custom_voice.channel_not_found"
	MsgCustomVoiceChannelCredentialMissing  = "custom_voice.channel_credential_missing"
	MsgCustomVoiceUpstreamUnavailable       = "custom_voice.upstream_unavailable"
	MsgCustomVoiceUpstreamResponseReadFail  = "custom_voice.upstream_response_read_failed"
	MsgCustomVoiceProcessFailed             = "custom_voice.process_failed"
	MsgCustomVoiceProcessFailedWithDetail   = "custom_voice.process_failed_with_detail"
	MsgCustomVoiceUpstreamBusy              = "custom_voice.upstream_busy"
	MsgCustomVoiceCredentialInvalid         = "custom_voice.credential_invalid"
	MsgCustomVoiceTooManyRequests           = "custom_voice.too_many_requests"
	MsgCustomVoiceBillingModelMissing       = "custom_voice.billing_model_missing"
	MsgCustomVoiceBillingModelUnavailable   = "custom_voice.billing_model_unavailable"
	MsgCustomVoiceBillingPriceInvalid       = "custom_voice.billing_price_invalid"
	MsgCustomVoiceQuotaQueryFailed          = "custom_voice.quota_query_failed"
	MsgCustomVoiceQuotaInsufficient         = "custom_voice.quota_insufficient"
	MsgCustomVoiceChargeFailed              = "custom_voice.charge_failed"
	MsgCustomVoicePreviewModelMissing       = "custom_voice.preview_model_missing"
	MsgCustomVoicePreviewBillingUnavailable = "custom_voice.preview_billing_model_unavailable"
	MsgCustomVoicePreviewBillingPriceBad    = "custom_voice.preview_billing_price_invalid"
	MsgCustomVoicePreviewTextTooLong        = "custom_voice.preview_text_too_long"
	MsgCustomVoiceFeatureDisabled           = "custom_voice.feature_disabled"
	MsgCustomVoiceVoiceCheckFailed          = "custom_voice.voice_check_failed"
	MsgCustomVoiceSaveFailed                = "custom_voice.save_failed"
	MsgCustomVoiceAudioFileReadFailed       = "custom_voice.audio_file_read_failed"
	MsgCustomVoiceUploadPrepareFailed       = "custom_voice.audio_upload_prepare_failed"
	MsgCustomVoiceUpstreamParseFailed       = "custom_voice.upstream_parse_failed"
	MsgCustomVoiceRequestBuildFailed        = "custom_voice.request_build_failed"
	MsgCustomVoiceVoiceIdEmpty              = "custom_voice.voice_id_empty"
	MsgCustomVoiceAlreadyProcessed          = "custom_voice.already_processed"
	MsgCustomVoiceNoPermission              = "custom_voice.no_permission"
	MsgCustomVoiceActivateFailedRefunded    = "custom_voice.activate_failed_refunded"
)
...
const (
	...
	MsgTicketReplyContentEmpty  = "ticket.reply_content_empty"
	MsgTicketReplyTooLong       = "ticket.reply_content_too_long"
	MsgTicketCreateFailed       = "ticket.create_failed"
	MsgTicketReplyFailed        = "ticket.reply_failed"
	MsgTicketStatusUpdateFailed = "ticket.status_update_failed"
	MsgTicketStatusConflict     = "ticket.status_conflict"
	MsgTicketAccessDenied       = "ticket.access_denied"
)
